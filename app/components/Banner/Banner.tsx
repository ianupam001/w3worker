        ...
        <div className="mx-auto max-w-7xl pt-16 sm:pt-20 pb-20 banner-image">
          <div className="text-center">
            <h1 className="text-4xl font-semibold text-navyblue sm:text-5xl  lg:text-6xl md:4px lh-96">
              Solve problem with an <br /> integrated Website Builder.
            </h1>
            <p className="mt-6 text-lg leading-8 text-bluegray">
              Try our website builder to design and develop your  (React.js/Next.js) website,
              with just <br /> drag and drop .
            </p>
          </div>
